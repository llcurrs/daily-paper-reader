...
tldr: 针对大规模工程系统中分布式融合面临的互相关性难以追踪的问题，本文提出了一种重叠协方差交集（OCI）框架。该方法扩展了传统的CI算法，能够利用来自多个来源的局部相关性结构信息。通过半正定规划（SDP）高效求解，OCI在保证对未知相关性鲁棒性的同时，显著提升了融合性能，适用于实时分布式系统。
selection_source: fresh_fetch
motivation: 在大规模分布式系统中，由于无法追踪复杂的互相关性，传统的融合方法难以在保证鲁棒性的同时实现高性能。
method: 提出重叠协方差交集（OCI）框架，通过半正定规划处理来自多个信息源的局部相关性结构。
result: 建立了OCI问题的可行性充要条件，并证明了可以通过高效的计算方法获得族最优解。
conclusion: OCI框架在保留对未知相关性鲁棒性的前提下，有效利用了结构化信息，提升了大规模系统的融合精度。
---
